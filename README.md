...
<link href="https://nih.likeadream.repl.co/style.css" rel="stylesheet" type="text/css" />
<script src="https://nih.likeadream.repl.co/script.js"></script>
<head>

</head>
<body><div id="bodyblur"><img src="https://i.postimg.cc/MZr8C39n/IMG-20220203-185859-580.jpg" width="100%" height="100%"/></div></div>

<div class="foto">
<!-- Foto Kamu dan Aku --><div class="image"><img id="ftKm" style="opacity:0;" src="" width="100px" height="100px"/><img id="ftAk" style="opacity:0;position:absolute;" src="https://i.postimg.cc/TYThY3mK/snuggles-caring-1.gif" width="130px" height="130px"/></div>
<!-- Nama Kamu --><span id="sp1"></span>
...
<!--<div id="trm" class="contTom"><a style="margin:12px 12px 12px 0;" class='button' onClick="iloveu();siap();">Terima</a><div id="Bn"><a style="margin:12px 12px 12px 0;" class='button' onClick="tolak()">Tolak</a></div></div>-->
...
function lanjut(){document.getElementById('lanjut').style.display = "none";document.getElementById('text').style.display = "none";document.getElementById('text2').style.display = "none";document.getElementById("text3").innerHTML = "&#127939;&#128168;";ketikakhir();}
  ...
  function ketikakhir() {
    ...
    document.getElementById("textakhir").innerHTML = "Oh iya, Jangan Lupa BAHAGIA Hari Ini :)";
    }
  }
  async function siap() {
    if(o<text3.length){
...
var audio = new Audio('https://nih.likeadream.repl.co/Hiduplah.mp3');audio.play();}
            ...
            async function kuis(){
                           var { value: persen } = await swals.fire({
                            title: 'Seberapa Sayang ' + nama + ' sama Aku?',
                        ...
                        if(persen){
                        	...
                        	text = "Good morning, " + nama + "! Jangan lupa sarapan yaaa:)         ";
                        	text2 = "Semangat jalani harinya, Jaga kesehatan yaww...             ";
                            textakhir = "Oh iya, Jangan Lupa BAHAGIA Hari Ini :)      ";
                            ketik();showDiv();play();
                    }}
</script>
</body>
